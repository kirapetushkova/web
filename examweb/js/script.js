...
const api_key = "5e69911a-fde2-4cbd-93e7-829bcb6c7280";
...
function updatePrice() {
    ...
    if (transferCheckbox.checked) {
        const новаяСтоимость = базоваяСтоимость + 1000;
        transferExtra.innerHTML = `(+1000₽)`;
        finalPrice.innerHTML = 'Итоговая стоимость: ' + String(fPrice + 1000) + "₽";
    } else {
